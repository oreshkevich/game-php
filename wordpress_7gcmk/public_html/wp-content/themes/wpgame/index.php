...
<section class="content">
  ...
  <div class="game-card game-card__order">
    ...
    <div class="game-info">
      <a href="#" class="btn-filter">NEWES</a>
      <h2>
        <?php the_title() ?>
      </h2>
      <p><?php echo get_the_excerpt() ?></p>
      <div class="game-platforms">
        <img src="<?php echo get_template_directory_uri() ?>/img/icons/ps.svg" alt="Playstation"><img
          src="<?php echo get_template_directory_uri() ?>/img/icons/xbox.svg" alt="Xbox"><img
          src="<?php echo get_template_directory_uri() ?>/img/icons/win.svg" alt="Windows">
      </div>
