...
<section class="content">
  <div class="game-card game-card__order">
    ...
    <div class="game-info">
      ...
      <h2><?php the_title() ?></h2>
      <ul>
        <li>Category: <span><?php $category = get_the_category();
                            echo $category[0]->name; ?></span></li>
        <li>Developer: <span><?php echo $value = get_post_meta($post->ID, 'Developer', true);
                              ?></span></li>
        <li>Date: <span><?php echo $value = get_post_meta($post->ID, 'Date', true);
                        ?></span></li>
