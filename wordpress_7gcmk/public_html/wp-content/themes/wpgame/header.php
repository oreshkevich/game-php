...
<body>
  <!-- cp27115-wordpress-7gcmk.tw1.ru -->
  <!-- Логин: admin
Пароль: q6YqyuzgYUTz
Реквизиты отправлены на:  -->
  <header class="header">
    <a href="#" class="logo">
    ...
    <div class="header-block">
      ...
      <div class="user"><img src="<?php echo get_template_directory_uri() ?>/img/user.png" alt=""><img
          src="<?php echo get_template_directory_uri() ?>/img/icons/arrow.svg" alt=""></div>
    </div>
  </header>
